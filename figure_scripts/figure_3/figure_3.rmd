...
```{r fig_3E, message = FALSE, warning = FALSE, fig.width = 5, fig.height = 6}
...
```{r fig_3F, warning = FALSE, message = FALSE, fig.width = 9, fig.height = 6}
...
```{r fig_3G, message = FALSE, warning = FALSE, fig.height = 6, fig.width = 4}
