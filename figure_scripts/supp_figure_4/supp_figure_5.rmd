...
```{r fig_S5B, message = FALSE, warning = FALSE, fig.height = 6, fig.width = 6}
...
```{r fig_S5C, message = FALSE, warning = FALSE, fig.height = 10, fig.width = 5}
