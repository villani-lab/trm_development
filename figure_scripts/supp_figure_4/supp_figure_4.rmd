...
```{r fig_S4A_skin, fig.height = 8, fig.width = 9}
...
```{r fig_S4A_gut, fig.height = 8, fig.width = 9}
...
```{r fig_S4B, fig.width = 5, fig.height = 8}
...
```{r fig_S4C, message = FALSE, warning = FALSE, fig.width = 6, fig.height = 6}
