...
```{r fig_s3a_skin_hmap, fig.width = 6, fig.height = 10}
...
```{r fig_s3a_skin_lines, fig.width = 8, fig.height = 8}
...
```{r fig_s3a_gut_hmap, fig.width = 6, fig.height = 10}
...
```{r fig_s3a_gut_lines, fig.width = 8, fig.height = 8}
...
```{r fig_S3B_skin, fig.height = 8, fig.width = 9}
...
```{r fig_S3B_gut, fig.height = 8, fig.width = 9}
...
```{r fig_S3C, fig.width = 5, fig.height = 8}
...
```{r fig_S3D, message = FALSE, warning = FALSE, fig.width = 6, fig.height = 6}
