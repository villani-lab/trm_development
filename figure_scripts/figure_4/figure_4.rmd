...
```{r fig_4A, message = FALSE, warning = FALSE, fig.width = 5, fig.height = 6}
...
```{r fig_4D, warning = FALSE, message = FALSE}
...
```{r fig_4G, warning = FALSE, message = FALSE, fig.width = 9, fig.height = 6}
...
```{r fig_4H, message = FALSE, warning = FALSE, fig.height = 6, fig.width = 4}
